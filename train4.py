...
if pkgutil.find_loader("torch"):
    import torch
    from deepLearningAgents import DQNAgent, OneHotDQNAgent, FullyConnectedDQNAgent2 ,AutoPriorityReplayBuffer
...
if __name__ == "__main__":
    ...
    playerAgent = FullyConnectedDQNAgent2(map_size)
    # playerAgent = pickle.load(open("FullyConnectedDQNAgent2.pkl", "rb"))
    # playerAgent.writer = SummaryWriter("runs/FullyConnectedDQNAgent2")
    ...
    pickle.dump(playerAgent, open("FullyConnectedDQNAgent2.pkl", "wb"))